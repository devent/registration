...
/**
 * Factory to create the registration key.
 *
 * @author Erwin Müller, erwin.mueller@deventm.de
 * @since 1.0
 */
public interface RegisterKeyFactory {

    /**
     * Creates the registration key.
     *
     * @param registration
     *            the {@link Registration} data.
     *
     * @return the {@link RegisterKey}.
     */
    RegisterKey create(Registration registration);
}
