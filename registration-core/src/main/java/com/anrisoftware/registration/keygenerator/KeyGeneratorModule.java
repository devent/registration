...
/**
 * Binds the key generator.
 *
 * @see KeyGeneratorFactory
 *
 * @author Erwin Müller, erwin.mueller@deventm.de
 * @since 1.0
 */
public class KeyGeneratorModule extends AbstractModule {

    @Override
    protected void configure() {
        install(new FactoryModuleBuilder().implement(KeyGenerator.class,
                KeyGenerator.class).build(KeyGeneratorFactory.class));
    }
