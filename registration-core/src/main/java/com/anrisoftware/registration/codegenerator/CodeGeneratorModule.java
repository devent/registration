...
/**
 * Binds the code generator.
 *
 * @see CodeGeneratorFactory
 *
...
public class CodeGeneratorModule extends AbstractModule {
    ...
    protected void configure() {
        install(new FactoryModuleBuilder().implement(CodeGenerator.class,
                CodeGenerator.class).build(CodeGeneratorFactory.class));
    }
